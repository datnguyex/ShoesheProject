<?php
    ...
    if (!empty($username) && !empty($password)) {
        ...
        if ($login_result == 1) {
            ...
            $_SESSION['login'] = 'Logout, ' . $username;
            header('location: http://undersized-guys.000.webhostapp.com');
            exit();
        } else {
            $_SESSION['errorlogin_message'] = 'Đăng nhập thất bại. Có thể đã sai user hoặc password';
            header('location: http://undersized-guys.000.webhostapp.com/login.php');
            exit();
        }
    }
        ...
        <div class="row py-5">
            ...
            <div class="col-sm-5 bg-light p-5" style="margin-left: -12px;">
                <div class="d-flex gap-2">
                    ...
                    <a href="signup.html" type="submit" class="btn btn-outline-primary rounded-pill">Sign up</a>
                </div>
